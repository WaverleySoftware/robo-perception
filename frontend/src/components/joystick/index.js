...
const Joystick = observer(() => {
  ...
  const handleClickEvent = (event) => {
    ...
    if (target.dataset.button && event.type === "mousedown") {
  ...
  return (
    <Grid sx={{margin: '0 auto', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
      <svg width="352" height="212" viewBox="0 0 352 212" fill="none" xmlns="http://www.w3.org/2000/svg" className={classes.root} onMouseDown={ handleClickEvent } onMouseUp={ handleClickEvent }>
        ...
        <path data-button="l3" d="M157.564 165C157.564 178.255 146.819 189 133.564 189C120.31 189 109.564 178.255 109.564 165C109.564 151.745 120.31 141 133.564 141C146.819 141 157.564 151.745 157.564 165Z" stroke={strokeColor} strokeWidth="2" fill={fillColor}/>
        <path data-button="r3" d="M237.564 165C237.564 178.255 226.819 189 213.564 189C200.31 189 189.564 178.255 189.564 165C189.564 151.745 200.31 141 213.564 141C226.819 141 237.564 151.745 237.564 165Z" stroke={strokeColor} strokeWidth="2" fill={fillColor}/>
        ...
        <path data-button="r1" d="M270.482 25.0001C262.458 25.0002 258.892 33.8637 258 38H289.752H322C316.896 25.0001 312.339 25 307.93 25.0001C292.773 25.0002 279.844 24.9999 270.482 25.0001Z" fill={fillColor} stroke={strokeColor} strokeWidth="2"/>
        <path data-button="l1" d="M81.42 25.0001C89.5072 25.0002 93.1014 33.8637 94 38H62H29C34.1437 25.0001 39.2361 25 43.6801 25.0001C58.9558 25.0002 71.985 24.9999 81.42 25.0001Z" fill={fillColor} stroke={strokeColor} strokeWidth="2"/>
        <path data-button="l2" d="M71.9778 2.00007C77.7251 2.00007 82.888 7.74867 85.42 12.6374C86.5468 14.8131 84.7917 17 82.3416 17H41.2857C38.358 17 36.434 13.9475 38.0825 11.528C43.8896 3.00498 50.4424 2.00007 52.9111 2.00007C65.3226 2.00022 64.3119 2.00007 71.9778 2.00007Z" fill={fillColor} stroke={strokeColor} strokeWidth="2.25"/>
        <path data-button="r2" d="M279.022 2.00007C273.275 2.00007 268.112 7.74867 265.58 12.6374C264.453 14.8131 266.208 17 268.658 17H309.714C312.642 17 314.566 13.9475 312.918 11.528C307.11 3.00498 300.558 2.00007 298.089 2.00007C285.677 2.00022 286.688 2.00007 279.022 2.00007Z" fill={fillColor} stroke={strokeColor} strokeWidth="2.25"/>
        <defs>
